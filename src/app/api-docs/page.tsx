...
export const metadata: Metadata = {
  title: "API docs",
  description:
    "The LedgerAI REST API lets firms push transactions, fetch categorization decisions, and sync back to their own tools.",
};
  ...
  return (
    <>
      <PageHero
        ...
        lead="The LedgerAI API is the same surface our reviewer console and integrations run on. OpenAPI spec, typed SDKs for TypeScript and Python, and a shared sandbox account for every firm on paid plans."
      />
        ...
        <div className="container prose-grid">
          ...
          <div className="prose-body">
            <p>
              ...
              <code style={{ fontFamily: "var(--mono)" }}>@ledgerai/node</code> and{" "}
              <code style={{ fontFamily: "var(--mono)" }}>ledgerai</code> on PyPI. Both are
              maintained in lockstep with the API.
            </p>
            <p>
              Full reference and a runnable sandbox are rolling out to pilot firms. Want early
              access? Email{" "}
              <a href="mailto:developers@ledgerai.com" style={{ color: "var(--blue-600)", fontWeight: 500 }}>
                developers@ledgerai.com
              </a>{" "}
